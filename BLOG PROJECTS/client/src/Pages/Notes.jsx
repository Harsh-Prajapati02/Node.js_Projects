...
const Notes = () => {
    ...
    return (
        <div className='d-flex flex-column flex-md-row' style={{ minHeight: "100vh" }}>
            <div className='w-100'>
                <h1 className='text-3xl font-semibold border-bottom border-gray-500 p-3 mt-3'>Notes Results:</h1>
                ...
                <div className='d-flex p-1 flex-wrap'>
                    {notes.length == 0 ? <div className='p-4 d-flex flex-wrap gap-4'>
                        ...
                        notes.map((el) => {
                            return (
                                <NoteCard key={el._id} id={el._id} title={el.title} body={el.body} image={el.notesImage} getAllUserNotes={getAllUserNotes} userId={userData?._id} />
                            )
                        })}
                </div>
            </div>
